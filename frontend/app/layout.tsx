...
export const metadata: Metadata = {
  title: "Stoly-Sklad | Современная мебель от производителя в Казахстане",
  description: "Дизайнерские столы и стулья премиального качества. Собственное производство, экологичные материалы и доставка по всему Казахстану (Семей, Астана).",
  keywords: ["мебель Казахстан", "столы Семей", "стулья Астана", "лофт мебель", "купить мебель Казахстан"],
};
