...
export const metadata: Metadata = {
  title: "Stoly-Sklad — Дизайнерская мебель премиального качества в Семее и Астане",
  description: "Огромный выбор столов, стульев и предметов интерьера в Казахстане. Премиальное качество, индивидуальный дизайн и быстрая доставка по Семею и Астане. Закажите мебель своей мечты прямо сейчас!",
  openGraph: {
    title: "Stoly-Sklad — Мебель твоей мечты в Семее и Астане",
    description: "Авторская мебель для дома и офиса в Казахстане. Узнайте больше в нашем каталоге.",
    type: "website",
  }
};
